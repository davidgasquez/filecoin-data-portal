# asset.description = DatacapStats verified client allowance history records
...
# asset.column = verifier_name | Allocator name from the parent client snapshot.
...
# asset.column = is_from_autoverifier | Does the allowance came from autoverifier?
# asset.column = retrieval_frequency | Retrieval frequency attributed upstream.
# asset.column = searched_by_proposal | Whether the allocation was searched.
# asset.column = issue_create_timestamp | Issue creation Unix timestamp.
# asset.column = has_remaining_allowance | Does still has remaining datacap?
