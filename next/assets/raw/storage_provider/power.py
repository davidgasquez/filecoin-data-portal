...
# asset.assert = raw_power_pibs > 0
# asset.assert = quality_adj_power_pibs >= 0
...
with provider_daily_power_changes as (
    select
        ...
        cast(raw_byte_power as float64) / pow(1024, 5) as raw_power_pibs,
        cast(quality_adj_power as int64) as quality_adj_power_bytes,
        cast(quality_adj_power as float64) / pow(1024, 5) as quality_adj_power_pibs
