with datacapstats_allocators as (
    select
        ...
        addressEth as allocator_eth_address,
        dcSource as datacap_source,
        auditStatus as audit_status,
        removed,
        ...
        to_timestamp(try_cast(createMessageTimestamp as numeric)) as message_created_at,
        verifiedClientsCount as verified_clients_count,
        try_cast(receivedDatacapChange as bigint) as received_datacap_change,
        try_cast(receivedDatacapChange as bigint) / power(1024, 4) as received_datacap_change_tibs,
        try_cast(receivedDatacapChange90Days as bigint) as received_datacap_change_90d,
        try_cast(receivedDatacapChange90Days as bigint) / power(1024, 4) as received_datacap_change_90d_tibs,
        try_cast(remainingDatacap as bigint) as remaining_datacap_bytes,
        try_cast(remainingDatacap as bigint) / power(1024, 4) as remaining_datacap_tibs,
        retries,
...
select
    ...
    da.created_at,
    da.issue_created_at,
    da.message_created_at,
    da.verified_clients_count,
    da.received_datacap_change,
    da.received_datacap_change_tibs,
    da.received_datacap_change_90d,
    da.received_datacap_change_90d_tibs,
    da.remaining_datacap_bytes,
    da.remaining_datacap_tibs,
    da.allocator_eth_address,
    da.datacap_source,
    da.audit_status,
    da.is_virtual,
    da.is_meta_allocator,
    da.is_inferred,
    da.retries,
    -- da.allowances,
    da.is_active,
