...
select
    ...
    b.end_epoch - b.sector_start_epoch as deal_length_epochs,
    date_part('day', end_at - sector_start_at) as deal_length_days,
    storage_price_per_epoch_fil * deal_length_epochs as deal_storage_cost_fil,
